        ...
        <div style={{ 
          ...
          <button 
            style={{
              ...
              borderRadius: '8px',
              cursor: 'pointer',
              background: activeTab === 'watchlist' ? '#8068ff' : 'transparent',
          ...
          <button 
            style={{
              ...
              borderRadius: '8px',
              cursor: 'pointer',
              background: activeTab === 'recommendations' ? '#8068ff' : 'transparent',
              color: activeTab === 'recommendations' ? '#ffffff' : 'var(--text-secondary)',
              transition: 'all 0.2s'
            }}
